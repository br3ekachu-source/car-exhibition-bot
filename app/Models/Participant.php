...
// app/Models/Participant.php
    ...
    public function notifyStatusUpdate()
    {
        $message = match($this->status) {
            'approved' => "🎉 Поздравляем, Ваша заявка на участие в IDDC, которое пройдет 20-21 сентября на Игора Драйв ОДОБРЕНА! Ссылка на вступление в группу https://t.me/+0M7Uo7L5t-YzNTQ6",
